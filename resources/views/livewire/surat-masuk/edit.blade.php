<div>
    <flux:button icon="edit" variant="subtle" data-modal-target="editSM-{{ $suratMasukId }}" data-modal-toggle="editSM-{{ $suratMasukId }}"></flux:button>
    <!-- Main modal -->
    <div wire:ignore.self  id="editSM-{{ $suratMasukId }}" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-500 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
