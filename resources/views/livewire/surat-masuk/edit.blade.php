<div>
    <!-- Main modal -->
    <div wire:ignore.self id="edit-SM-{{ $suratMasukId }}" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-500 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5">
                    ...
                    <flux:button wire:click="form.resetForm" icon="X" variant="subtle" data-modal-toggle="edit-SM-{{ $suratMasukId }}">
                    </flux:button>
                </div>
                <!-- Modal body -->
