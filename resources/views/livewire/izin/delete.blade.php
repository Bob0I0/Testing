<div>
    <flux:modal.trigger name="deleteKU-{{ $izinId }}">
        <flux:button icon="trash" variant="subtle"></flux:button>
    </flux:modal.trigger>

    <flux:modal name="deleteKU-{{ $izinId }}" class="md:w-100" title="Konfirmasi Hapus Data Surat Masuk">
        <div class="space-y-6">
            ...
            <flux:text variant="strong" class="mt-4 text-center text-base">
                ...
                <p class="text-sm mt-1">Perizinan dengan nama <strong>{{ $name }}</strong>
