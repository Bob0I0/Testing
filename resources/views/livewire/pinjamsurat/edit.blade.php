<div>
    <flux:button icon="edit" variant="subtle" data-modal-target="editPS-{{ $pinjamSuratId }}" data-modal-toggle="editPS-{{ $pinjamSuratId }}"></flux:button>
    <!-- Main modal -->
    <div wire:ignore.self id="editPS-{{ $pinjamSuratId }}" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-500 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        ...
                        <div class="flex">
                            ...
                            <flux:modal name="persetujuan_editSM-{{ $pinjamSuratId }}" class="md:w-96">
                                <div class="space-y-6">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <flux:modal.close>
                                            <flux:button variant="primary" color="green" type="submit" class="w-full" data-modal-toggle="editPS-{{ $pinjamSuratId }}">Simpan</flux:button>
                                        </flux:modal.close>    
                                        <flux:modal.close>                                         
