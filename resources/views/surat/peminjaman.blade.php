<x-layouts.app :title="__('peminjaman surat')">
    <div class="card flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="card-header">
            <h1 class="text-2xl font-semibold">{{ __('Peminjaman Surat') }}</h1>
            <p class="text-sm text-gray-500">{{ __('Manage your letter borrowing here.') }}</p>
        </div>
        <div class="card-body">
